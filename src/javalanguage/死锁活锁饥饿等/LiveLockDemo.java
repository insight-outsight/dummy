...
/**
 * 
 * Here's a very simple Java example of livelock where a husband and wife are trying to 
 * eat soup, but only have one spoon between them. Each spouse is too polite, and will 
 * pass the spoon if the other has not yet eaten.
 * 
 * @author zcx
 * @Refer http://stackoverflow.com/questions/1036364/good-example-of-livelock
 */
