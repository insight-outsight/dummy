...
public class UsingCustomClassLoaderLoadClassesInCustomDirTset {
    ...
    public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
    	System.out.println(UsingCustomClassLoaderLoadClassesInCustomDirTset.class.getClassLoader());
    	...
    	System.out.println(UsingCustomClassLoaderLoadClassesInCustomDirTset.class.getClassLoader());
 		...
 		Class sampleObjectClass = Thread.currentThread().getContextClassLoader().loadClass("javalanguage.classloader.custom.SampleObject");
 		//还可以这样
...
/*        Method method55 = sampleObjectClass.getMethod("setSof", SampleObjectField.class);
