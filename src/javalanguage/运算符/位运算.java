...
public class 位运算 {
	...
	public static void main(String[] args) {
		...
		System.out.println(0x80000008);//1000 0000 0000 0000 0000 0000 0000 1000 = -2147483640
		int b7 = 25;//0000 0000 0000 0000 0000 0000 0001 1001 
		System.out.println("原值===="+b7);//
		System.out.println("移1====="+(b7 << 26));
		System.out.println("移2====="+(b7 << 27));
		System.out.println("移3===="+(b7 << 28)); 
